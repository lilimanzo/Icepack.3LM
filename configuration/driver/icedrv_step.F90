...
! authors: William H. Lipscomb, LANL
      ...
      use icedrv_flux, only: flat, fswabs, flwout, evap, evaps, evapi, taf ! LM added taf
      use icedrv_flux, only: Tref, Qref, Qref_iso, Uref!, TsfKr ! 697
      ...
      do i = 1, nx
        ...
        call icepack_step_therm1(dt=dt, &
            ...
            yday = yday,  prescribed_ice = prescribed_ice, taf=taf(i))!, TsfKr=TsfKr(i)) ! 697
